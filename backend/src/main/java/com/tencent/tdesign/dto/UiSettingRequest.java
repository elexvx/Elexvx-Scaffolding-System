...
public class UiSettingRequest {
  ...
  public String getLogoExpandedUrl() {
    return logoExpandedUrl;
  }

  public void setLogoExpandedUrl(String logoExpandedUrl) {
    this.logoExpandedUrl = logoExpandedUrl;
  }

  public String getLogoCollapsedUrl() {
    return logoCollapsedUrl;
  }

  public void setLogoCollapsedUrl(String logoCollapsedUrl) {
    this.logoCollapsedUrl = logoCollapsedUrl;
  }
  ...
  public void setLightStartTime(String lightStartTime) {
    this.lightStartTime = lightStartTime;
  }

  public String getDarkStartTime() {
    return darkStartTime;
  }

  public void setDarkStartTime(String darkStartTime) {
    this.darkStartTime = darkStartTime;
  }
  ...
  public Boolean getIsSidebarCompact() {
    return isSidebarCompact;
  }

  public void setIsSidebarCompact(Boolean isSidebarCompact) {
  ...
  public Boolean getMenuAutoCollapsed() {
    return menuAutoCollapsed;
  }

  public void setMenuAutoCollapsed(Boolean menuAutoCollapsed) {
    this.menuAutoCollapsed = menuAutoCollapsed;
  }
  ...
  public void setSplitMenu(Boolean splitMenu) {
  ...
  public Boolean getIsFooterAside() {
    return isFooterAside;
  }

  public void setIsFooterAside(Boolean isFooterAside) {
    this.isFooterAside = isFooterAside;
  }

  public Boolean getIsSidebarFixed() {
    return isSidebarFixed;
  }

  public void setIsSidebarFixed(Boolean isSidebarFixed) {
  ...
  public Boolean getIsUseTabsRouter() {
    return isUseTabsRouter;
  }

  public void setIsUseTabsRouter(Boolean isUseTabsRouter) {
    this.isUseTabsRouter = isUseTabsRouter;
  }
  ...
  public Boolean getSmsAliyunEnabled() {
    return smsAliyunEnabled;
  }

  public void setSmsAliyunEnabled(Boolean smsAliyunEnabled) {
    this.smsAliyunEnabled = smsAliyunEnabled;
  }
  ...
  public String getSmsAliyunTemplateCode() {
    return smsAliyunTemplateCode;
  }

  public void setSmsAliyunTemplateCode(String smsAliyunTemplateCode) {
    this.smsAliyunTemplateCode = smsAliyunTemplateCode;
  }

  public String getSmsAliyunRegionId() {
    return smsAliyunRegionId;
  }

  public void setSmsAliyunRegionId(String smsAliyunRegionId) {
    this.smsAliyunRegionId = smsAliyunRegionId;
  }

  public String getSmsAliyunEndpoint() {
    return smsAliyunEndpoint;
  }

  public void setSmsAliyunEndpoint(String smsAliyunEndpoint) {
    this.smsAliyunEndpoint = smsAliyunEndpoint;
  }

  public Boolean getSmsTencentEnabled() {
  ...
  public String getSmsTencentEndpoint() {
    return smsTencentEndpoint;
  }

  public void setSmsTencentEndpoint(String smsTencentEndpoint) {
    this.smsTencentEndpoint = smsTencentEndpoint;
  }
