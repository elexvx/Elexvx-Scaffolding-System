    ...
    <t-row :gutter="[32, 24]">
      ...
      <t-col :xs="24" :sm="12">
        ...
        <t-form-item v-if="form.type === 'image_gray'" label="图片地址" name="imageUrl">
          <t-input v-model="form.imageUrl" placeholder="http/https 图片地址" style="max-width: 500px; width: 100%" />
        </t-form-item>
      </t-col>
      <t-col :xs="24" :sm="12">
      ...
      <t-col :span="24">
        <t-form-item>
          <div class="tdesign-starter-action-bar">
            <t-button theme="primary" :disabled="!isAdmin" type="submit">保存</t-button>
          </div>
        </t-form-item>
      </t-col>
    </t-row>
